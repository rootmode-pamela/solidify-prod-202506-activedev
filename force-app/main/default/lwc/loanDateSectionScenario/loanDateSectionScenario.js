...
// import MyModal from "c/submitNotesModal"; //Doesn't use at the moment
...
export default class LoanDateSectionScenario extends NavigationMixin(LightningElement) {
    @api variant = 'Default';
    ...
    @track isCrudeCalculatorOpen = false;
    ...
    openCalculator() {
        this.isCrudeCalculatorOpen = true;
    }

    closeCalculator() {
        this.isCrudeCalculatorOpen = false;
    }

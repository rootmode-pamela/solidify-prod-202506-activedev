({
    search : function(component, event, helper) {
        console.log('search lookup parameters:' + component.get('v.accountId') + " " + component.get('v.contactId'));
    ...
    createNewRecord : function(component, event, helper) { 
        component.set('v.openNewProperty', true);
        console.log('@@@ contactId: ' + component.get('v.contactId'));
        /*
        var createRecordEvent = $A.get("e.force:createRecord"),  
        objectName = component.get("v.objectAPIName"),
        searchTermName = component.get('v.searchTerm');  
        createRecordEvent.setParams({  
            ...
            "panelOnDestroyCallback": function(event) {  
                ...
                let action = component.get("c.getRecentlyCreatedRecords");  

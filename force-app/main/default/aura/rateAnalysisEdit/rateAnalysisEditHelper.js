({
     ...
     calculateAPR : function(payment, present, terms) {
        ...
        return rate;
       	...
       	handleUpdateNew : function(component, event, helper){
  ...
  if(override == false){          
        ...
        component.set("v.simpleRecord.New_Loan_Amount__c", loanAmount);
        ...
        if(addFee == "No"){
            ...
            component.set('v.simpleRecord.Total_Cost_1__c', totalCost1);          
        	component.set('v.simpleRecord.Total_Cost_2__c', totalCost2);
        	component.set('v.simpleRecord.Total_Cost_3__c', totalCost3);
        	component.set('v.simpleRecord.Total_Cost_4__c', totalCost4);
        	component.set('v.simpleRecord.Total_Cost_5__c', totalCost5);
        	component.set('v.simpleRecord.Total_Cost_6__c', totalCost6);           
            component.set("v.simpleRecord.Total_Loan_Amount1__c", loanAmount);
            component.set("v.simpleRecord.Total_Loan_Amount2__c", loanAmount);
            component.set("v.simpleRecord.Total_Loan_Amount3__c", loanAmount);
            component.set("v.simpleRecord.Total_Loan_Amount4__c", loanAmount);
            component.set("v.simpleRecord.Total_Loan_Amount5__c", loanAmount);
            component.set("v.simpleRecord.Total_Loan_Amount6__c", loanAmount);            
        } 
        
        if(addFee == "Yes"){
            console.log('@@@ totalCost1: ' + totalCost1);
            console.log('@@@ adj1/100: ' + adj1/100);
            console.log('@@@ origFee: ' + origFee);
            ...
            component.set('v.simpleRecord.Total_Cost_1__c', totalCost1new);           
        	component.set('v.simpleRecord.Total_Cost_2__c', totalCost2new);
        	component.set('v.simpleRecord.Total_Cost_3__c', totalCost3new);
        	component.set('v.simpleRecord.Total_Cost_4__c', totalCost4new);
        	component.set('v.simpleRecord.Total_Cost_5__c', totalCost5new);
        	component.set('v.simpleRecord.Total_Cost_6__c', totalCost6new);            
            component.set("v.simpleRecord.Total_Loan_Amount1__c", (parseFloat(loanAmount)+parseFloat(totalCost1new)));
            component.set("v.simpleRecord.Total_Loan_Amount2__c", (parseFloat(loanAmount)+parseFloat(totalCost2new)));
            component.set("v.simpleRecord.Total_Loan_Amount3__c", (parseFloat(loanAmount)+parseFloat(totalCost3new)));
            component.set("v.simpleRecord.Total_Loan_Amount4__c", (parseFloat(loanAmount)+parseFloat(totalCost4new)));
            component.set("v.simpleRecord.Total_Loan_Amount5__c", (parseFloat(loanAmount)+parseFloat(totalCost5new)));
            component.set("v.simpleRecord.Total_Loan_Amount6__c", (parseFloat(loanAmount)+parseFloat(totalCost6new)));
        }       
         ...
         if(totalCostCheck6 < 0){
            ...
            component.set("v.simpleRecord.Total_Cost_6__c", totalCostCheck6);
            component.set("v.simpleRecord.Total_Loan_Amount6__c", loanAmount);
                    }
        ...
        if(totalCostCheck5 < 0){
            ...
            component.set("v.simpleRecord.Total_Cost_5__c", totalCostCheck5);
            component.set("v.simpleRecord.Total_Loan_Amount5__c", loanAmount);
        }
        ...
        if(totalCostCheck4 < 0){
            ...
            component.set("v.simpleRecord.Total_Cost_4__c", totalCostCheck4);
            component.set("v.simpleRecord.Total_Loan_Amount4__c", loanAmount);
        }
        ...
        if(totalCostCheck3 < 0){
            ...
            component.set("v.simpleRecord.Total_Cost_3__c", totalCostCheck3);
            component.set("v.simpleRecord.Total_Loan_Amount3__c", loanAmount);
        }
     

        var lockPer = component.find('lockPer').get("v.value");
        component.set('v.simpleRecord.Lock_Period_Days__c', lockPer);
        
        var fico = component.find('ficoScore').get("v.value");
        component.set('v.simpleRecord.FICO_Score__c', fico);
        
        var estValue = component.find('estVal').get("v.value");
        component.set('v.simpleRecord.Estimate_Value__c', estValue);
        
        var terms = component.find('fixedTermYears').get("v.value");
        component.set('v.simpleRecord.Fixed_Term_Years__c', terms);

		var prepDate = component.find('prepDate').get("v.value");
        component.set('v.simpleRecord.Prepared_Date__c', prepDate);
        
		var borrower = component.find('borrowerName').get("v.value");
        component.set('v.simpleRecord.Borrower_Name_Text__c', borrower);
        
        
        var lenderFees = component.find('estLender').get("v.value");
        component.set('v.simpleRecord.Est_Fees_Lender__c', lenderFees);
        
        var titleFees = component.find('estTitle').get("v.value");
        component.set('v.simpleRecord.Est_Fees_Title_Escrow__c', titleFees);
        
        var appraisalFees = component.find('estCredit').get("v.value");
        component.set('v.simpleRecord.Est_Fees_Appraisal_Credit__c', appraisalFees);
        
        var treasuryYield = component.find('treasuryYield').get("v.value");
        component.set("v.simpleRecord.X10_Yr_Treasury_Yield__c", treasuryYield);
        
        
        var compensation = component.find('origFee').get("v.value");
        component.set("v.simpleRecord.Origination_Fee__c", compensation);
        
        var transactionType = component.find('transactionType').get("v.value");
        component.set('v.simpleRecord.Transaction_Type__c', transactionType);
        

        
        var loanType = component.find('loanType').get("v.value");
        component.set('v.simpleRecord.Loan_Type__c', loanType);

		var addLoanFees = component.find('addFees').get("v.value");
        component.set('v.simpleRecord.Add_Fees_to_Loan_Balance__c', addLoanFees);
        ...
        var price5 = component.find('price5').get("v.value");
        var price6 = component.find('price6').get("v.value");       
        component.set("v.simpleRecord.Price_1__c", price1);
        component.set("v.simpleRecord.Price_2__c", price2);
        component.set("v.simpleRecord.Price_3__c", price3);
        component.set("v.simpleRecord.Price_4__c", price4);
        component.set("v.simpleRecord.Price_5__c", price5);
        component.set("v.simpleRecord.Price_6__c", price6);
        ...
        component.set("v.simpleRecord.Rate_1__c", rate1);
        component.set("v.simpleRecord.Rate_2__c", rate2);
        component.set("v.simpleRecord.Rate_3__c", rate3);
        component.set("v.simpleRecord.Rate_4__c", rate4);
        component.set("v.simpleRecord.Rate_5__c", rate5);
        component.set("v.simpleRecord.Rate_6__c", rate6);

        var orig = component.find("origPrice1").get("v.value");  
        component.set("v.simpleRecord.Orig__c", orig);
        ...
        component.set("v.simpleRecord.Adj_Price1__c", adj1);
        component.set("v.simpleRecord.Adj_Price2__c", adj2);
        component.set("v.simpleRecord.Adj_Price3__c", adj3);
        component.set("v.simpleRecord.Adj_Price4__c", adj4);
        component.set("v.simpleRecord.Adj_Price5__c", adj5);
        component.set("v.simpleRecord.Adj_Price6__c", adj6);
                 	     
        var gpa = component.find("gpa").get("v.value");
        component.set("v.simpleRecord.Global_Pricing_Adjuster__c", gpa);
        ...
        component.set("v.simpleRecord.Monthly_PI_Pmt1__c", finalResult1);
        ...
        component.set("v.simpleRecord.Monthly_PI_Pmt2__c", finalResult2);
        ...
        component.set("v.simpleRecord.Monthly_PI_Pmt3__c", finalResult3);
        ...
        component.set("v.simpleRecord.Monthly_PI_Pmt4__c", finalResult4);
        ...
        component.set("v.simpleRecord.Monthly_PI_Pmt5__c", finalResult5);
        ...
        component.set("v.simpleRecord.Monthly_PI_Pmt6__c", finalResult6);
        ...
        component.set("v.simpleRecord.APR1__c", apr1);
        component.set("v.simpleRecord.APR2__c", apr2);
        component.set("v.simpleRecord.APR3__c", apr3);
        component.set("v.simpleRecord.APR4__c", apr4);
        component.set("v.simpleRecord.APR5__c", apr5);
        component.set("v.simpleRecord.APR6__c", apr6);
        component.set('v.simpleRecord.Years_Until_BE6__c', 0);
